...
sudo apt update -y; apt upgrade -y; wget https://raw.githubusercontent.com/Waldo60/ocho.cero/master/instalscript.sh &> /dev/null; chmod 777 instalscript.sh* && ./instalscript.sh*
